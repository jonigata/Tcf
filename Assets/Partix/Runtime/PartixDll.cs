...
public class PartixDll : MonoBehaviour {
    ...
    [DllImport("partix_dll")]
    public static extern IntPtr CreateVehicle2(
        IntPtr world,
        int vertexCount, Vector3[] vertices,
        int tetrahedronCount, Tetrahedron[] tetrahedra,
        int faceCount, Triangle[] faces,
    ...
    [DllImport("partix_dll")]
    public static extern int GetContactCount(IntPtr world, IntPtr b);

    [DllImport("partix_dll")]
    public static extern void GetContacts(
        IntPtr world, IntPtr b, IntPtr[] a);

    [DllImport("partix_dll")]
    public static extern ClassId GetClassId(
        IntPtr world, IntPtr b);
